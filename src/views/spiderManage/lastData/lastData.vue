    ...
    <el-tabs v-model="activeName" @tab-click="handleClick" style="margin-top: 20px;">
      ...
      <el-tab-pane label="商家" name="storePage">
        <el-form :inline="true" :model="storeSearch" class="demo-form-inline" size="mini">
          <el-form-item label="关键字">
            <el-input v-model="storeSearch.keyWord" placeholder="请输入商家名、官网"></el-input>
          </el-form-item>
        ...
        <el-table :data="storeData.storeList" stripe style="width: 100%" border>
        ...
        <el-pagination class="paginationStyle" background layout="total ,prev, pager, next" @current-change="storeChange" :total="storeData.pageTotal" :page-size="storeData.pageSize"></el-pagination>
      </el-tab-pane>
      ...
      <el-tab-pane label="优惠券" name="couponPage">
        <section>
          ...
          <el-table :data="couponData.couponList" stripe style="width: 100%" border>
            <el-table-column prop="id" label="ID" align="center"></el-table-column>
            <el-table-column prop="storeName" label="商家名" align="center"></el-table-column>
          ...
          <el-pagination class="paginationStyle" background layout="total ,prev, pager, next" @current-change="couponChange" :total="couponData.pageTotal" :page-size="couponData.pageSize"></el-pagination>
        </section>
      </el-tab-pane>
