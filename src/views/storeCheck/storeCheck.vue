...
<template>
  <section class="storeCheckPage">
    <section class="pageSearch" >
      <el-form :inline="true" :model="searchForm" class="demo-form-inline" size="mini">
        ...
        <el-form-item label="信息是否完整">
          <el-select v-model="searchForm.isComplete" placeholder="请选择分类">
            <el-option v-for="completeItem in isCompleteList" :key="completeItem.key" :value="completeItem.key" :label="completeItem.value"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="排除站点列表">
          <el-select v-model="searchForm.siteId" placeholder="请选择站点">
            <el-option v-for="siteItem in siteList" :key="siteItem.id" :value="siteItem.id" :label="siteItem.name"></el-option>
          </el-select>
        </el-form-item>
      ...
      <el-table :data="tableData.list" stripe style="width: 100%" border @selection-change="selectStore" @row-click="checkRow" ref="storeListTable">
