...
<template>
  <section class="spiderStatPage">
    ...
    <el-table :data="data" stripe style="width: 100%" border v-show="type == 1" v-loading="loading">
    ...
    <el-table :data="storeData" stripe style="width: 100%" border v-show="type == 2" v-loading="loading">
      <el-table-column prop="date" label="日期" align="center"></el-table-column>
