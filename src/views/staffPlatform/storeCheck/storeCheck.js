...
export default {
  ...
  methods: {
    ...
    batchPass() {
      ...
      let _this = this,
        validList = [],
        invalidList = [],
        currList = JSON.parse(JSON.stringify(_this.tableData.list));
    ...
    singleApproval(storeId, approval) {
      //单个审核
      let _this = this;
    ...
    batchApproval(validList, invalidList) {
      //批量审核
      let _this = this;
  ...
  computed: {
    ...mapGetters(['spiderList', 'countryList', 'approvalList', 'isCompleteList'])
  }
};
